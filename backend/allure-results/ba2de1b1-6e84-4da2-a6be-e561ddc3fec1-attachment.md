...
- Location: tests\e2e\libros.spec.js:57:5
...
Error: locator.click: Error: strict mode violation: locator('button[type=submit]') resolved to 3 elements:
    ...
    3) <button type="submit" class="btn btn-primary btn-block">Guardar cambios</button> aka getByRole('button', { name: 'Guardar cambios' })
...
- generic [ref=e1]:
  ...
  - generic [ref=e138]:
    ...
    - generic [ref=e140]:
      - heading "Editar libro" [level=2] [ref=e141]
      - paragraph [ref=e142]: CIE-008
      - generic [ref=e143]:
        - generic [ref=e144]:
          - generic [ref=e145]: Título
          - textbox "Título" [active] [ref=e146]: Playwright Testing Actualizado
        - generic [ref=e147]:
          - generic [ref=e148]: Autor
          - textbox "Autor" [ref=e149]: George Orwell
        - generic [ref=e150]:
          - generic [ref=e151]:
            - generic [ref=e152]: ISBN
            - textbox "ISBN" [ref=e153]: "9780451524935"
          - generic [ref=e154]:
            - generic [ref=e155]: Año
            - spinbutton "Año" [ref=e156]: "1949"
        - generic [ref=e157]:
          - generic [ref=e158]:
            ...
            - combobox "Categoría" [ref=e160]:
              ...
              - option "Ciencia"
              - option "Ciencia Ficción" [selected]
              - option "Historia"
              - option "Infantil"
              - option "Novela"
              - option "Poesía"
          ...
          - generic [ref=e161]:
            ...
            - spinbutton "Ejemplares" [disabled] [ref=e163]: "5"
        - generic [ref=e164]:
          - generic [ref=e165]: Sinopsis
          - textbox "Sinopsis" [ref=e166]: 1984, escrito por George Orwell, es una obra representativa de ciencia ficción.
        - generic [ref=e167]:
          - button "Cancelar" [ref=e168] [cursor=pointer]
          - button "Guardar cambios" [ref=e169] [cursor=pointer]
```
